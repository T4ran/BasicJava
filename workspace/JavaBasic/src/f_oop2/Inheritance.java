...
public class Inheritance {
	...
	public static void main(String[] args) {
		 ...
		 * - 부모 클래스의 멤버와 자식 클래스의 멤버의 이름이 중복될 때 둘은 구분하기 위해 사용한다.
		 * 
		 * <<super()>>
		 ...
		 * 
		 * <<Singleton(싱글톤 패턴)>>
		 * - 객체 생성을 제한하여 하나의 객체만 사용하게 하는 디자인 패턴이다.	//의도
		 * - 객체들간에 객체를 공유하기 위해 사용한다.						//기능
		 */
		...
		System.out.print(t.getHour() + "시 " + t.getMinute() + "분 " + t.getSecond() + "초\n");
		System.out.println(t);
		
		//Singleton s = new Singleton();	//private이므로 접근 불가.
