...
/*
		...
		[2-6] 다음 중 키워드가 아닌 것은? (모두 고르시오) ( b,c,d,e )(대문자일 경우 class)
		a. if
		b. True
		c. NULL
		d. Class
		...
		a. b = (byte)i;
		b. ch = (char)b;	- b의 표현범위에 -값이 있음
		c. short s = (short)ch; - s의 표현범위에 -값이 있음
		d. float f = (float)l;	- 부동소수점 참조
		e. i = (int)ch;
		
		[2-10] char타입의 변수에 저장될 수 있는 정수는? (10진수로 고르시오)
		0~65535
		
		[2-11] 다음중 변수를 잘못 초기화 한 것은 모두 고르시오 ? ( a, b, c, d )
		a. byte b = 256;	- 범위가 0~255
		b. char c = '';		- 공백문자 불가능
		c. char answer = 'no';	- ''대신 ""사용
		d. float f = 3.14	- 3.14f
		e. double d = 1.4e3f;	- 궂이 f를 왜 넣었는지는 모르겠지만 가능
